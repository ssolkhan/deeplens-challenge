...
"G7": "2345678", "G6": "1236789", "G5": "23456789", "G4": "345678",
...
"D2": "9", "D3": "8", "D1": "36"}
    ...
    def test_naked_twins1(self):
        self.assertTrue(solution.naked_twins1(self.before_naked_twins_1) in self.possible_solutions_1,
                        "Your naked_twins function produced an unexpected board.")
    ...
    def test_naked_twins3(self):
        self.assertTrue(solution.naked_twins(self.before_naked_twins_3) in self.possible_solutions_2,
                        "Your naked_twins function produced an unexpected board.")
    def test_naked_twins31(self):
        self.assertTrue(solution.naked_twins1(self.before_naked_twins_3) in self.possible_solutions_2,
                        "Your naked_twins function produced an unexpected board.")
